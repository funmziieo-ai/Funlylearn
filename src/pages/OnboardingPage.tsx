  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5] text-slate-800 font-sans flex flex-col justify-between p-4 sm:p-6">
      ...
      <div className="max-w-md mx-auto w-full flex items-center justify-between py-2">
          ...
          {[1, 2, 3].map(s => (
            <div
              ...
              className={
                ...
                (step === s ? 'w-6 bg-[#064E3B]' : step > s ? 'w-2 bg-emerald-400' : 'w-2 bg-slate-200')
              }
            />
          ))}
        </div>
        ...
        {onExit && (
          <button onClick={onExit} className="text-xs font-bold text-slate-500 hover:text-slate-800">
            Exit
          </button>
        )}
      </div>
        ...
        {step === 3 && (
          <div className="space-y-5 text-center">
            ...
            <div className="space-y-3 pt-1 text-left">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-500">
                    Mama Titi teaches in Standard English
                  </p>
                </div>
                {language === 'en' && (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-500">
                    Mama Titi teaches in Yoruba only
                  </p>
              ...
              <div className="w-full p-4 rounded-3xl border border-slate-200 bg-slate-50 flex items-center space-x-4 opacity-60">
                ...
                <div className="flex-1">
                  <h4 className="font-serif font-bold text-lg text-slate-400">Igbo</h4>
              ...
              <div className="w-full p-4 rounded-3xl border border-slate-200 bg-slate-50 flex items-center space-x-4 opacity-60">
                ...
                <div className="flex-1">
                  <h4 className="font-serif font-bold text-lg text-slate-400">Hausa</h4>
                  <p className="text-xs text-slate-400">
            ...
            {language === 'yo' && (
              <div className="p-4 rounded-2xl bg-purple-50 border border-purple-200 text-left">
                ...
                <p className="text-sm text-purple-700 italic">
                  "Ẹ kaaro! Oruko mi ni Mama Titi. Jẹ ki a kọ ẹkọ papọ loni!"
                </p>
            ...
            <p className="text-[11px] text-slate-400">
              You are seconds away from your first lesson with Mama Titi!
            </p>
          </div>
        )}
      </div>
