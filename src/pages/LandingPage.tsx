  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] text-slate-900 font-sans flex flex-col justify-between">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-10 flex-1 flex flex-col items-center w-full">
        ...
        {/* Hero Section */}
        <div className="w-full rounded-3xl overflow-hidden shadow-lg mb-6 relative bg-emerald-600">
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 p-5 sm:p-6">
            <div className="flex-1 text-center sm:text-left">
              <div className="inline-flex items-center gap-1.5 bg-emerald-900/30 border border-emerald-300/30 px-3 py-1 rounded-full mb-3">
              ...
              <p className="text-emerald-50 text-sm sm:text-base leading-relaxed mb-4">
            ...
            <div className="w-36 h-36 sm:w-44 sm:h-44 shrink-0 rounded-2xl overflow-hidden border-4 border-white/30 shadow-lg">
              <img
        ...
        {/* Stats Row */}
        <div className="w-full py-4 px-6 rounded-2xl bg-emerald-600 grid grid-cols-3 text-center mb-6 gap-2 shadow-md text-white">
          <div className="space-y-0.5">
            <div className="text-lg">👥</div>
            <div className="text-sm font-bold">1,480+</div>
            <p className="text-[11px] opacity-90">active scholars</p>
          </div>
          <div className="space-y-0.5 border-x border-emerald-400/40">
            <div className="text-lg">📖</div>
        ...
        <div className="w-full grid grid-cols-1 gap-4 mb-6">
          ...
          {/* Card 1: Homework Snap */}
          <div
            onClick={onStartLearning}
            className="relative bg-gradient-to-br from-orange-400 to-orange-600 rounded-3xl p-5 shadow-md border-b-4 border-orange-800/30 hover:scale-[1.02] active:scale-[0.99] transition-transform cursor-pointer text-white"
          >
            <div className="flex items-center gap-2.5 mb-2">
              <Camera className="w-7 h-7" />
              <h3 className="text-lg font-bold">Homework Snap & Stories</h3>
            </div>
          ...
          {/* Card 2: Naija Lingo */}
          <div className="relative bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-3xl p-5 shadow-md border-b-4 border-indigo-800/30 hover:scale-[1.02] active:scale-[0.99] transition-transform cursor-pointer text-white">
            <div className="flex items-center gap-2.5 mb-2">
              <Languages className="w-7 h-7" />
              <h3 className="text-lg font-bold">Naija Lingo & Letter Crush</h3>
            </div>
            <p className="text-sm text-white/90 mb-4 leading-snug">
          ...
          {/* Card 3: Smart Study */}
          <div className="relative bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-3xl p-5 shadow-md border-b-4 border-emerald-800/30 hover:scale-[1.02] active:scale-[0.99] transition-transform cursor-pointer text-white">
            <div className="flex items-center gap-2.5 mb-2">
              <GraduationCap className="w-7 h-7" />
              <h3 className="text-lg font-bold">Smart Study & Revisions</h3>
            </div>
            <p className="text-sm text-white/90 mb-4 leading-snug">
        ...
        <div className="w-full rounded-3xl bg-white border-2 border-emerald-100 shadow-lg p-5 sm:p-6 mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-emerald-700 mb-1 flex items-center gap-2">
            <Heart className="w-5 h-5 text-orange-400 fill-orange-400" />
            Catch Up Program
          </h2>
          <p className="text-base font-semibold text-orange-500 italic mb-2">
